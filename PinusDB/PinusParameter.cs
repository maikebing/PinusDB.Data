...
namespace PinusDB.Data
{
    ...
    /// <summary>
    ///     Represents a parameter and its value in a <see cref="PinusCommand" />.
    /// </summary>
    ...
    public class PinusParameter : DbParameter
    {
        private string _parameterName = string.Empty;
        private object _value;
        private int? _size;
        private PinusType? _TaosType;

        /// <summary>
        ///     Initializes a new instance of the <see cref="PinusParameter" /> class.
        /// </summary>
        public PinusParameter()
        {
        }
        ...
        public PinusParameter(string name, object value)
        {
        ...
        public PinusParameter(string name, PinusType type)
        {
            if (string.IsNullOrEmpty(name))
            {
                throw new ArgumentNullException(nameof(name));
        ...
        public PinusParameter(string name, PinusType type, int size)
            : this(name, type)
            => Size = size;
        ...
        public PinusParameter(string name, PinusType type, int size, string sourceColumn)
            : this(name, type, size)
        ...
        /// <remarks>Due to Taos's dynamic type system, parameter values are not converted.</remarks>
        /// <seealso href="http://Taos.org/datatype3.html">Datatypes In Taos Version 3</seealso>
        public virtual PinusType PinusType
        {
        ...
        /// </summary>
        public virtual void ResetPinusType()
        {
            DbType = DbType.String;
            PinusType = PinusType.String;
        }
